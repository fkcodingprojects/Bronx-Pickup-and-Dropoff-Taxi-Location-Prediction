...
# Define different n_estimators values to test
n_estimators_values = [10, 50, 100]

for n_estimators in n_estimators_values:
    # Create Random Forest model with the specified n_estimators
    model_pu = RandomForestClassifier(random_state=42, n_estimators=n_estimators)
    model_do = RandomForestClassifier(random_state=42, n_estimators=n_estimators)
