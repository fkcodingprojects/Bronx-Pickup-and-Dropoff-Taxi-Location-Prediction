...
for max_features in max_features_values:
    # Create Random Forest model with the specified max_features
    model_pu = RandomForestClassifier(random_state=42, max_features=max_features)
    model_do = RandomForestClassifier(random_state=42, max_features=max_features)
