...
for max_depth in max_depth_values:
    # Create Random Forest model with the specified max_depth
    model_pu = RandomForestClassifier(random_state=42, max_depth=max_depth)
    model_do = RandomForestClassifier(random_state=42, max_depth=max_depth)
