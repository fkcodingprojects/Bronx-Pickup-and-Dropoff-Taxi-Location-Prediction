...
# Define different min_impurity_decrease values to test
min_impurity_decrease_values = [0.1, 0.3, 0.5]

for min_impurity_decrease in min_impurity_decrease_values:
    # Create Random Forest model with the specified min_impurity_decrease
    model_pu = RandomForestClassifier(random_state=42, min_impurity_decrease=min_impurity_decrease)
    model_do = RandomForestClassifier(random_state=42, min_impurity_decrease=min_impurity_decrease)
    ...
    print(f"\nResults for min_impurity_decrease = {min_impurity_decrease}:")
