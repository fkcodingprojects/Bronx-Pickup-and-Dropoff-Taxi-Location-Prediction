...
model_pu = RandomForestClassifier(random_state=42)
model_do = RandomForestClassifier(random_state=42)

# Fit the models with the preprocessed training data with progress bar
...
print("Test Data with Predictions for 2019:")
print(test_data[['date', 'hour', 'PULocationID', 'DOLocationID', 'PULocationID_pred', 'DOLocationID_pred']])
