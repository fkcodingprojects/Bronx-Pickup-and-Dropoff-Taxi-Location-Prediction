...
# Define different criteria values to test
criteria_values = ['gini', 'entropy']

for criterion in criteria_values:
    # Create Random Forest model with the specified criterion
    model_pu = RandomForestClassifier(random_state=42, criterion=criterion)
    model_do = RandomForestClassifier(random_state=42, criterion=criterion)
