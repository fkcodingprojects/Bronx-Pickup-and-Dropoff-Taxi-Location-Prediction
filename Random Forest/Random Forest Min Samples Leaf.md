...
# Define different min_samples_leaf values to test
min_samples_leaf_values = [1, 3, 5]

for min_samples_leaf in min_samples_leaf_values:
    # Create Random Forest model with the specified min_samples_leaf
    model_pu = RandomForestClassifier(random_state=42, min_samples_leaf=min_samples_leaf)
    model_do = RandomForestClassifier(random_state=42, min_samples_leaf=min_samples_leaf)
    ...
    print(f"\nResults for min_samples_leaf = {min_samples_leaf}:")
