...
# Define different min_samples_split values to test
min_samples_split_values = [2, 5, 10]

for min_samples_split in min_samples_split_values:
    # Create Random Forest model with the specified min_samples_split
    model_pu = RandomForestClassifier(random_state=42, min_samples_split=min_samples_split)
    model_do = RandomForestClassifier(random_state=42, min_samples_split=min_samples_split)
    ...
    print(f"\nResults for min_samples_split = {min_samples_split}:")
