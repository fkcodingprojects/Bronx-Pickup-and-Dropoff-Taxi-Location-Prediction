...
# Define different max_leaf_nodes values to test
max_leaf_nodes_values = [10, 100, 1000]

for max_leaf_nodes in max_leaf_nodes_values:
    # Create Random Forest model with the specified max_leaf_nodes
    model_pu = RandomForestClassifier(random_state=42, max_leaf_nodes=max_leaf_nodes)
    model_do = RandomForestClassifier(random_state=42, max_leaf_nodes=max_leaf_nodes)
    ...
    print(f"\nResults for max_leaf_nodes = {max_leaf_nodes}:")
