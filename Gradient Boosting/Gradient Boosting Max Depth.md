...
for max_depth in max_depth_values:
    # Create Gradient Boosting model with the specified max_depth
    model_pu = GradientBoostingClassifier(random_state=42, max_depth=max_depth)
    model_do = GradientBoostingClassifier(random_state=42, max_depth=max_depth)
