...
# Create Gradient Boosting model with log loss (deviance)
model_pu = GradientBoostingClassifier(random_state=42, loss='deviance')
model_do = GradientBoostingClassifier(random_state=42, loss='deviance')
...
print(f"Loss Function: Log Loss (Deviance)")
