...
for n_estimators in n_estimators_values:
    # Create Gradient Boosting model with the specified number of estimators
    model_pu = GradientBoostingClassifier(random_state=42, n_estimators=n_estimators)
    model_do = GradientBoostingClassifier(random_state=42, n_estimators=n_estimators)
