...
# Define different values for min_impurity_decrease to test
min_impurity_decrease_values = [0.1, 0.3, 0.5]

for min_impurity_decrease in min_impurity_decrease_values:
    # Create Gradient Boosting model with the specified min_impurity_decrease
    model_pu = GradientBoostingClassifier(random_state=42, min_impurity_decrease=min_impurity_decrease)
    model_do = GradientBoostingClassifier(random_state=42, min_impurity_decrease=min_impurity_decrease)
    ...
    print(f"Min Impurity Decrease: {min_impurity_decrease}")
