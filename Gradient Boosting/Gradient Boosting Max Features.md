...
# Define different values for max_features to test
max_features_values = ["sqrt", "log2"]

for max_features in max_features_values:
    # Create Gradient Boosting model with the specified max_features
    model_pu = GradientBoostingClassifier(random_state=42, max_features=max_features)
    model_do = GradientBoostingClassifier(random_state=42, max_features=max_features)
