...
# Define different values for min_samples_leaf to test
min_samples_leaf_values = [1, 3, 5]

for min_samples_leaf in min_samples_leaf_values:
    # Create Gradient Boosting model with the specified min_samples_leaf
    model_pu = GradientBoostingClassifier(random_state=42, min_samples_leaf=min_samples_leaf)
    model_do = GradientBoostingClassifier(random_state=42, min_samples_leaf=min_samples_leaf)
