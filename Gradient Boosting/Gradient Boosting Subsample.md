...
# Define different values for subsample to test
subsample_values = [0.3, 0.6, 1]

for subsample in subsample_values:
    # Create Gradient Boosting model with the specified subsample
    model_pu = GradientBoostingClassifier(random_state=42, subsample=subsample)
    model_do = GradientBoostingClassifier(random_state=42, subsample=subsample)
