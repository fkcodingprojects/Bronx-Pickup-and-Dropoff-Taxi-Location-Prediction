...
# Define different values for min_samples_split to test
min_samples_split_values = [2, 5, 10]

for min_samples_split in min_samples_split_values:
    # Create Gradient Boosting model with the specified min_samples_split
    model_pu = GradientBoostingClassifier(random_state=42, min_samples_split=min_samples_split)
    model_do = GradientBoostingClassifier(random_state=42, min_samples_split=min_samples_split)
