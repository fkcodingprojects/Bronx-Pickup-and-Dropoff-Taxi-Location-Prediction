...
for lr in learning_rates:
    # Create Gradient Boosting model with the specified learning rate
    model_pu = GradientBoostingClassifier(random_state=42, learning_rate=lr)
    model_do = GradientBoostingClassifier(random_state=42, learning_rate=lr)
