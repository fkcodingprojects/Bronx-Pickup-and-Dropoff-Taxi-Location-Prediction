...
# Define different degree values to test
degree_values = [1, 3, 5]

for degree in degree_values:
    # Create SVM model with the specified degree
    model_pu = SVC(random_state=42, degree=degree)
    model_do = SVC(random_state=42, degree=degree)
