...
# Create SVM model with class_weight='balanced'
model_pu = SVC(random_state=42, class_weight='balanced')
model_do = SVC(random_state=42, class_weight='balanced')
...
print("Accuracy (Both PULocationID and DOLocationID match): {:.2f}%".format(percentage_matching_pairs))
print("Accuracy (PULocationID matches): {:.2f}%".format(pu_percentage_matching_pairs))
print("Accuracy (DOLocationID matches): {:.2f}%".format(do_percentage_matching_pairs))
